...
import { expandDeckEntries, shuffleCardInstances, type CardInstance } from '../src/shared/playDeck.js'
import type { CardColor } from '../src/types/scryfall.js'

import {
  applyPlayerDesignation,
  buildInitialCommandZone,
  formatZoneLabel,
  getAutoBattlefieldPosition,
  getControllablePermanent,
  getNextPlayer,
  placeOwnedCardInZone,
  setPermanentStack,
  setStackPosition,
  takeOwnedCardFromZone,
  unstackPermanent,
} from './play-server/gameState.js'
import {
  buildDebugDeckSelection,
  buildDefaultPlayerDesignations,
  buildTokenCard,
  clampCounterDelta,
  clampDrawAmount,
  clampTurnNumber,
  DEBUG_ROOM_INITIAL_PLACEHOLDERS,
  DEFAULT_DISCONNECT_GRACE_PERIOD_MS,
  sanitizeCounterKind,
  sanitizeDebugRoomPassword,
  sanitizeLabel,
  sanitizePermanentNote,
  sanitizePlayerCounterKind,
  sanitizePlayerNote,
  sanitizeTargets,
} from './play-server/helpers.js'
import {
  buildGameSnapshot,
  buildRoomDirectoryEntry,
  buildRoomSnapshot,
} from './play-server/snapshots.js'
import type {
...
export class PlayServer {
  ...
  private buildRoomDirectoryEntry(room: RoomState) {
